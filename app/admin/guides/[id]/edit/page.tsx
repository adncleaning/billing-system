        ...
        <div className="space-y-6 animate-fade-in">
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                setForm((p) => ({
                                    ...
                                    beneficiaryIndex: 0, // reset beneficiary
                                    invoiceIds: [], // opcional: para evitar inconsistencias al cambiar remitente
                                }))
                            }
                        >
                            ...
                            <div key={idx} className="grid grid-cols-12 gap-2 items-center bg-gray-50 rounded-md p-2">
                                ...
                                <div className="col-span-2 flex items-center mt-5">
                                    <input
                                        type="checkbox"
                                        checked={s.included}
                                        onChange={(e) => updateService(idx, { included: e.target.checked })}
                                    />
            ...
            <div className="card p-6 space-y-3">
                ...
                <p className="text-xs text-gray-500">
                    Aquí solo mostramos lo asociado. Si quieres que en edición también puedas cambiar invoices, lo agregamos.
                </p>
